...
public class ReadRawAudio {
    ...
    public int[] readdouble()
    {
        try
        {
            ...
            WavFile wavFile = WavFile.openWavFile(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC) + "/mu/70dB_NS_1089-134686-0035.wav"));
